...
{{name}} is a newly created category that will hold all the related tutorials under it. Each tutorial content is contained in a `t-` prefixed directory, and 3 default sections of the tutorial in it.
